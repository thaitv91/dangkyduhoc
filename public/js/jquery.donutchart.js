(function ($, u) {
    $.fn.drawDoughnutChart = function (data, options) {
        ...
        $(document.createElementNS('http://www.w3.org/2000/svg', 'path')).attr({ "d": getHollowCirclePath(baseDoughnutRadius, baseCutoutRadius), "fill": settings.baseColor }).appendTo($svg);
        ...
        function pathMouseEnter(e) {
            ...
            $tip.text(data[order].title + ": " + prefix + data[order].value + postfix)
                .fadeIn(200);
        ...
        function drawDoughnutText(animationDecimal, segmentTotal) {
            $summaryNumber.css({ opacity: animationDecimal }).text( prefix + (segmentTotal * animationDecimal).toFixed(0) + postfix);
        }
