...
<div class="container">
	...
	<div class="undergraduate-courses" id="apply-online">
		...
		<div class="tags">
			<a href="#" class="selected"> Accounting &amp; Finance <i class="fa fa-check"></i></a>
			<a href="#">Bioengineering <i class="fa fa-check"></i></a>
			<a href="#">Biological Science <i class="fa fa-check"></i></a>
			<a href="#">Business Studies</a>
			<a href="#">Chemical Engineering <i class="fa fa-check"></i></a>
			<a href="#">Chemistry Civil <i class="fa fa-check"></i></a>
			<a href="#">Engineering <i class="fa fa-check"></i></a>
			<a href="#">Computer <i class="fa fa-check"></i></a>
			<a href="#"> Accounting &amp; Finance <i class="fa fa-check"></i></a>
			<a href="#">Bioengineering <i class="fa fa-check"></i></a>
			<a href="#">Biological Science <i class="fa fa-check"></i></a>
			<a href="#">Business Studies <i class="fa fa-check"></i></a>
			<a href="#">Chemical Engineering <i class="fa fa-check"></i></a>
			<a href="#">Chemistry Civil <i class="fa fa-check"></i></a>
			<a href="#">Engineering <i class="fa fa-check"></i></a>
			<a href="#">Computer <i class="fa fa-check"></i></a>
