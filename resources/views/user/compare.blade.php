...
<div class="compare-page compare-div page" id="page_compare">
	<div class="compare-div sortablediv ui-sortable">
      ...
      <div class="compare-col content-col ui-sortable-handle" data-courseid="1517" data-priority="0" id="compareDiv_1517">
			...
			<div class="col-lg-12 col-md-12 col-xs-12 col-xs-12 feature-row text-center relative" style="background-color: rgb(255, 255, 255);">
				<div class=" feature feature21 padtop20 padbot20px" data-rowno="21" style="height: 160px;">
					<div class="chart" id="donutchart-1517">
						<svg height="120" viewbox="0 0 120 120" width="120" xmlns="http://www.w3.org/2000/svg">
						<path d="M 60.047779602644 0.000019024089922936582 A 60 60 0 1 1 60.04266117332405 0.000015166466162952474 Z M 60.03199587999303 15.00001137484962 A 45 45 0 1 0 60.035834701983 15.000014268067446 Z" fill="#eee"></path>
						<g opacity="0.9999998780673678">
							<path d="M 60.00000000000001 0 A 60 60 0 1 1 21.43276493796691 105.9626846438487 L 31.07457370347518 94.47201348288652 A 45 45 0 1 0 60 15 Z" data-order="0" fill="#A3CA5A" stroke="#0C1013" stroke-width="0"></path>
							<path d="M 21.43276493796691 105.9626846438487 A 60 60 0 0 1 59.999954032480595 1.7607248992135283e-11 L 59.99996552436045 15.000000000013202 A 45 45 0 0 0 31.07457370347518 94.47201348288652 Z" data-order="1" fill="#4484B3" stroke="#0C1013" stroke-width="0"></path>
						</g></svg>
						<div class="doughnutSummary" style="width: 60px; height: 60px; margin-left: -30px; margin-top: -30px;">
							<p class="doughnutSummaryTitle">per year</p>
							<p class="doughnutSummaryNumber" style="opacity: 1;">S$36K</p>
						</div>
					</div>
					<div class="clearBoth"></div>
				</div>
