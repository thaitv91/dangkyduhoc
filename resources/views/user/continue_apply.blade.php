				...
				<div id="step_2" class="questionaire section block">
					...
					<table id="education" class="exp">
						<tbody data-index="0">
							...
							<tr>
								<td class="td-sm">
									<input type="dates" name="edu_start[]" placeholder="Start" datatype="edu_start" index="0" class="hasDatepicker" value="{{ Carbon\Carbon::parse($value->edu_start)->format('d/m/Y') }}"/>
								</td>
								<td class="td-sm">
									<input type="dates" name="edu_end[]" placeholder="End" datatype="edu_end" index="0" class="hasDatepicker" value="{{ Carbon\Carbon::parse($value->edu_end)->format('d/m/Y') }}"/>
								</td>
								<td>
									<input type="text" name="edu_school_name[]" placeholder="Name of School or Institution" datatype="edu_school_name" index="0" value="{{ $value->edu_school_name }}">
								</td>
								<td class="td-md">
