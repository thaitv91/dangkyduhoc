			...
			<div class="box-body">
				<div class="col-md-8 col-md-offset-2">
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<textarea class="form-control my-editor" rows="5" id="about" name="about" value="{{ old('about') }}"></textarea>    
							@if($errors->has('about'))
	                            <span class="help-block">
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<textarea class="form-control my-editor" rows="5" id="about_en" name="about_en" value="{{ old('about_en') }}"></textarea>    
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<textarea class="form-control my-editor" rows="5" id="campus" name="campus" value="{{ old('campus') }}"></textarea>    
