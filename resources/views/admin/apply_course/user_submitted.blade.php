...
<div class="box">
	<div class="box-header">
		<div class="col-md-11"><h3 class="box-title">User Submitted</h3></div>
	</div>
	<!-- /.box-header -->
	<div class="box-body">
		<table id="example2" class="table table-bordered table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td><a href="{{ route('admin.applyCourse.detail',['user_id'=>$value->user_id]) }}" class="btn btn-success btn-xs">Detail</a></td>
				</tr>
				@endforeach
			</tbody>
		</table>
