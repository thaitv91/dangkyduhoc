			...
			<div class="col-md-8 col-md-offset-2">
				<div class="box-body">
					...
					<div class="form-group">
						...
						<textarea class="form-control my-editor" rows="5" id="content" name="content">{{ old('content') }}</textarea>
					</div>
					<div class="form-group">
						<label for="name">Content (English)</label>
						<textarea class="form-control my-editor" rows="5" id="content_en" name="content_en">{{ old('content_en') }}</textarea>
					</div>
					<div class="form-group">
						...
						<div class="">
							<select class="form-control" id="type" name="type">
							    ...
							    <option value="submit" 		@if (old('type')=='submit') 	selected @endif>Submit</option>
