			...
			<div class="box-body">
				<div class="col-md-8 col-md-offset-2">
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" name="ranking_title" id="ranking_title" value="{{ $data['ranking_title'] }}">
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" name="ranking_title_en" id="ranking_title_en" value="{{ $data['ranking_title_en'] }}">
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<input type="number" class="form-control" name="ranking_point" id="ranking_point" value="{{ $data['ranking_point'] }}">
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" name="ranking_subject" id="ranking_subject" value="{{ $data['ranking_subject'] }}">
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" name="ranking_subject_en" id="ranking_subject_en" value="{{ $data['ranking_subject_en'] }}">							
						</div>
					</div>
						...
						<div class="col-md-9">
							<select class="selectpicker " id="country_slug" name="country_slug" title="Choose one of the following..." data-live-search="true" tabindex="-98">
                              ...
                              @if(count($country)!=0)
                                  ...
                                  <option @if($db_country->slug == $data['country_slug']) selected @endif  value="{{$db_country->slug}}" data-tokens="{{$db_country->slug}}" >{{$db_country->slug }} </option>
                                  @endforeach
                               @endif
                              @if(count($country)==0)
                              <option value=""><em>(Don't have)</em></option>
