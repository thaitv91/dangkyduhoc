			...
			<div class="col-md-8 col-md-offset-2">
				<div class="box-body">
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" name="year_founded" id="year_founded" value="{{ $data['year_founded'] }}" placeholder="Choose one year....">
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" name="student_population" id="student_population" value="{{ $data['student_population'] }}">
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" name="staff_population" id="staff_population" value="{{ $data['staff_population'] }}">
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" name="male_number" id="male_number" value="{{ $data['male_number'] }}">
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" name="female_number" id="female_number" value="{{ $data['female_number'] }}">	
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" name="international_students" id="international_students" value="{{ $data['international_students'] }}">
