		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class=""><a href="{{ route('admin.course') }}"><i class="fa fa-link"></i> <span>Course</span></a></li>
				</ul>
				<!-- /.sidebar-menu -->
			</section>
			<!-- /.sidebar -->
...
<script src="{{asset('js/multi-select/bootstrap-select.js')}}" type="text/javascript"></script>
